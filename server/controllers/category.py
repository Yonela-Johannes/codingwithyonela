...
def fetch_category(id):
    query = """SELECT id,title FROM category WHERE id=%s ORDER BY title,id;"""
    ...
    try:
        ...
        return response
# create title
def create_category(category, account_id) :
    query = """INSERT INTO category (category, account_id)
    ...
    try:
        with  connection as conn:
            with  conn.cursor() as cur:
                ...
                cur.execute(query, (category, account_id))
