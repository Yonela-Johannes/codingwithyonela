    ...
    return (
        loading ? (<Loader disable={true} />) : (
            <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.2 }} className={`${theme == "light" ? "bg-white text-bg_primary" : "bg-bg_core border-bg_core text-slate-300"} flex flex-col gap-2 border p-2 lg:p-4 mb-3`}>
