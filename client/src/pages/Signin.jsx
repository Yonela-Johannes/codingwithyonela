...
import { activeSignup, disableAuthModals, login, logout } from "../features/user/authSlice";
...
const Signin = () => {
  ...
  return (
    <motion.div
      ...
      } flex flex-col items-center justify-center lg:items-center absolute h-screen lg:h-sceen w-full lg:z-50 backdrop-blur-xl overflow-hidden top-0 left-0 right-0 bottom-0`}
    >
      <div
        className={` ${
      ...
      >
        ...
        <div className="flex-1 w-full">
          ...
          >
            ...
            <div onClick={() => (dispatch(disableAuthModals()), dispatch(activeSignup()))} className="my-1 lg:my-2 text-[#646464] text-sm">
