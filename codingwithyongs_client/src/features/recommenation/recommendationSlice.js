...
const initialState = {
  ...
  export const createRecommendation = createAsyncThunk('recommendations/response', async (data) => {
    const response = await axios.post(`${apiUrl}recommendation-response`, data);
    return response.data;
  });
